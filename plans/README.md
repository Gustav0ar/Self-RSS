...
| [035](035-android-session-and-request-lifecycle.md) | End account and reader sessions without accepting stale work | P1 | L | 033 | IN PROGRESS; repository ownership implemented, UI and foreground pending |
