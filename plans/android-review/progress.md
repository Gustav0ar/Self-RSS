...
| Cache-first actions and bounded outbox delivery | 036, delivery | fix/android-outbox-delivery | pending | 518 JVM tests, isolated builds, lint and seven emulator checks pass |
| Effective mutation state and durable unread counts | 036, reconciliation | fix/android-cache-mutation-authority | pending | Reconcile existing PRs #38 and #42; extend count persistence and rejection authority |
