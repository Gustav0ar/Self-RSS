...
| Authenticated result ownership and offline admission | 035, authentication contract | fix/android-authenticated-owner | pending | 497 JVM tests, lint, isolated builds and 18 emulator checks pass; source review complete |
| Account screen lifetimes and foreground collection | 035, remaining | fix/android-account-screens | pending | Immutable feature ownership and disposable ViewModel stores next |
