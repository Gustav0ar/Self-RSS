...
| Cache-first actions and bounded outbox delivery | 036, delivery | fix/android-outbox-delivery | [#60](https://github.com/Gustav0ar/Self-RSS/pull/60) | Open; 518 JVM tests, isolated builds, lint and seven emulator checks pass |
| Effective mutation state and durable unread counts | 036, reconciliation | fix/android-mutation-reconciliation | pending | Reconcile existing PRs #38 and #42; extend count persistence and rejection authority |
| Revisioned article snapshots | 036, API prerequisite | feat/article-state-snapshots | pending | Implemented; SQLite supplies paired state on cache hits; full API integration, unit tests, shared/web types and web build pass |
