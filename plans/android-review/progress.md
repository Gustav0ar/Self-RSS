...
| Revision-ordered local article state | 036, reconciliation | fix/android-mutation-reconciliation | pending | 538 JVM tests, lint, isolated builds and 30 emulator checks pass; ready for separate review |
| UI mutation ordering and durable unread counts | 036, remaining | pending | pending | Effective UI rejection, bulk-hint refresh, count persistence and actual process-death mutation recovery remain |
