...
| Foreground collection and cached subscription reads | 035, 036 prerequisite | fix/android-foreground-work | pending | 511 JVM tests, 26 emulator checks, lint and isolated APK builds pass; source review complete |
| Worker execution ownership | 035, remaining | fix/android-worker-account-lifecycle | pending | Capture identity across complete worker execution and polling; preserve durable scheduling |
