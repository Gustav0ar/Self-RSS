...
| Repository account ownership | 035, data integration | fix/android-session-lifecycle | pending | 481 JVM tests, lint, isolated builds, 37 emulator checks and external process recovery pass |
| Authentication actions and account screen lifetimes | 035, remaining | fix/android-auth-actions | pending | Superseding actions, bound feature lifetimes and foreground collection next |
