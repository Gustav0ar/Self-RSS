...
INSERT INTO `__new_feeds`("id", "user_id", "category_id", "title", "site_url", "feed_url", "favicon_url", "description", "polling_interval_minutes", "last_synced_at", "last_sync_error", "last_sync_error_at", "next_sync_at", "sync_status", "created_at", "updated_at") SELECT "id", "user_id", "category_id", "title", "site_url", "feed_url", "favicon_url", "description", "polling_interval_minutes", "last_synced_at", "last_sync_error", "last_sync_error_at", "next_sync_at", "sync_status", "created_at", "updated_at" FROM `feeds`;--> statement-breakpoint
