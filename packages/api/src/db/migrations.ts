...
const PROTECTED_TABLES = [
	...
	{ name: 'feed_sources', keyColumns: ['id'] },
	{ name: 'feeds', keyColumns: ['id'] },
	{ name: 'feed_fetch_jobs', keyColumns: ['id'] },
	{ name: 'feed_fetch_snapshots', keyColumns: ['id'] },
	{ name: 'feed_snapshot_deliveries', keyColumns: ['id'] },
	{ name: 'feed_refresh_requests', keyColumns: ['id'] },
	{ name: 'feed_refresh_request_items', keyColumns: ['id'] },
	{ name: 'feed_discovery_candidates', keyColumns: ['id'] },
